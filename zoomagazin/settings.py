"""
Django settings for zoomagazin project.
...
SECRET_KEY = 'django-insecure-#-fkevxy)brk=yo_ly#586_(o%@9y@fss%8m9-mzw!97+nrjc+'
...
WSGI_APPLICATION = 'zoomagazin.wsgi.application'
...
LOGOUT_REDIRECT_URL = '/'     # Куда отправлять после выхода (на главную)
LOGIN_URL = '/login/'         # Куда отправлять гостей, если они лезут на закрытую страницу (например, в профиль)

# Настройки для пользовательских файлов (картинок)
MEDIA_URL = '/media/'
