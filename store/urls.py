...
urlpatterns = [
    ...
    path('manager/orders/bulk-delete/', views.bulk_delete_orders, name='bulk_delete_orders'),
    path('manager/report/export-csv/', views.export_report_csv, name='export_report_csv'),
